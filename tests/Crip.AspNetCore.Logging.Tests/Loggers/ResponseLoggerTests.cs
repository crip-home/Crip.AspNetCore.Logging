...
public class ResponseLoggerTests
{
    ...
    public async Task LogRequest_DebugWritesOnlyStatusAndHeaders()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogRequest_TraceWritesStatusAndHeadersAndBody()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogRequest_AppliesContentMiddleware()
    {
        // Arrange
        var loggerMock = CreateFor(LogLevel.Trace);
