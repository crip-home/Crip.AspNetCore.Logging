...
public class HttpLoggerTests
{
    ...
    public async Task LogRequest_CallsLoggerWithRequestScope()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogRequest_SkipsIfPredicatesSaysToSkip()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogResponse_CallsLoggerWithRequestAndResponseScope()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogResponse_SkipsIfPredicatesSaysToSkip()
    {
        // Arrange
        EndpointPredicate predicate = new(exclude: true, patterns: new[] { "/master/*" });
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogInfo_CallsLoggerWithRequestAndResponseScope()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public async Task LogInfo_SkipsIfPredicatesSaysToSkip()
    {
        // Arrange
        EndpointPredicate predicate = new(exclude: true, patterns: new[] { "/master/*" });
    ...
    [Fact, Trait("Category", "Unit")]
    public void LogError_CallsLoggerWithRequestResponseScope()
    {
        // Arrange
    ...
    [Fact, Trait("Category", "Unit")]
    public void LogError_CallsLoggerWithRequestAndDefaultStatusScope()
    {
        // Arrange
